...
%%% GUSTAV TO-DO - add with Marcos method for reference for pics
...
\subsection{Working with colored images}
...
%%% I HAVE COMMENTED OUT THE TEXT BELOW FOR THE IMAGE THEORY %%%
%%% I BELIEVE WHAT I HAVE PASTED IN IS A NEWER VERSION (MADE BY MARCO), %%%
%%% AND SHOULD REPLACE THE ORIGINAL TEXT %%%
%%% - GUSTAV %%%
...
After all the feature's extractions, a binary object can be defined by its features value that would be stored into a \textit{feature vector} in order to have a list where to start our BLOB's classification. On the Figures \ref{fig:BinaryIm} and \ref{fig:BinaryImTable} 
...
\caption{Binary image with Bounding Box and Center-of-Mass}
\label{fig:BinaryIm}
\end{minipage}
\hspace{0.5cm}
\begin{minipage}[b]{0.45\linewidth}
...
\label{fig:BinaryImTable}
\end{minipage}
\caption{The table corresponding to the Fig. \ref{fig:BinaryIm} shows two other features that can be calculated (the \textbf{\textit{perimeter}} and the \textbf{\textit{area}})}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{figure}[ht]
\begin{subfig}[b]{0.45\linewidth}
\centering
\includegraphics[width=1\linewidth]{Pictures/Theory/binary_image.png}
\caption{A gull}
\label{fig:BinaryIm}
\end{subfig}%
...
\begin{subfig}[b]{0.45\linewidth}
\centering
\includegraphics[width=\textwidth]{Pictures/Theory/binary_image_table.png}
\caption{A tiger}
\label{fig:BinaryImTable}
\end{subfig}
~ %add desired spacing between images, e. g. ~, \quad, \qquad etc. 
%(or a blank line to force the subfigure onto a new line)
\caption{The table corresponding to the Fig. \ref{fig:BinaryIm} shows two other features that can be calculated (the \textbf{\textit{perimeter}} and the \textbf{\textit{area}})}\label{fig:Features}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
