...
\begin{figure}[htbp] \centering
\begin{minipage}[b]{0.45\textwidth} \centering
\includegraphics[width=1.00\textwidth]{Pictures/Theory/8connec_kernel.png} 
\end{minipage} \hfill
\begin{minipage}[b]{0.45\textwidth} \centering
\includegraphics[width=1.00\textwidth]{Pictures/Theory/4connec_kernel.png} 
\end{minipage} \\ % Captions og labels
\begin{minipage}[t]{0.45\textwidth}
\caption{8 connectivity labeling kernel} % Venstre caption og label
\label{fig:8connecK}
\end{minipage} \hfill
\begin{minipage}[t]{0.45\textwidth}
\caption{4 connectivity labeling kernel} % Højre caption og label
\label{fig:4connecK}
\end{minipage}
\end{figure}

Figure \eqref{fig:8connecK}
