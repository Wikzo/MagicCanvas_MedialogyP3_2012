...
%% I moved a paragraph to the begining of the section. But I'm still not sure if the above part is useful as we will be describing everything again... - Marta %%

The combination of these different techniques makes it possible to get a functional program, but before use them, it is necessary to know how they work. The next section will explain the different techniques that used and also why and how they were implemented on the project. Figure \ref{fig:ip_framework} illustrates the framework used typically when working with image processing.
